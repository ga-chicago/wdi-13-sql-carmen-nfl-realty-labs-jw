...
SELECT * FROM country
	WHERE country.region = 'Southern Europe' AND country.population > 0
...
SELECT * FROM city
	...
	WHERE country.code = 'SMR' AND city.name NOT LIKE 'San Marino';
...
SELECT country.name, country.code, country.capital FROM country
